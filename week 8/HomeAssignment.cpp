...
void Menu(Product products[], int size)
{
  ...
  do
  {
    cout << "Please enter a number:" << endl
         ...
         << "Press 5 to print the sales of a product greater than a certain amount" << endl
         << "Press 6 to Display all the products" << endl;
    int op;
    cin >> op;
    if (op == 1)
    {
    ...
    {
      int productNum, saleamount;
      cout << "Enter the product number : ";
      cin >> productNum;
      cout << "Enter the sales amount : ";
      cin >> saleamount;
      printSales(products[productNum - 1].sales, saleamount);
    }
    else if (op == 6)
